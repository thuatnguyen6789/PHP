...
<head>
    <meta charset="UTF-8">
    <title>Register - Custom Shirt Web Template</title>
        ...
        if (isset($_SESSION['username'])){
            echo '<div class="gallery-upload">
                            ...
                            <form action="includes/gallery-upload.inc.php" method="post" enctype="multipart/form-data">
                                ...
                                <input type="text" name="Phone Or Email" placeholder="Phone Or Email...">
                                <input type="password" name="Password" placeholder="Password..." aria-required="true">
                                <button type="submit" name="submit"><a href="login.php">Register</a></button>
