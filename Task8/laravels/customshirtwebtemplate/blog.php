    ...
    <div id="contents">
        ...
        <div id="contentsss">
            <div id="sidebar">
                ...
                <ul id="archives">
                    <li>
                        <a href="blog.php">January 2021</a>
                    </li>
                    <li>
                        <a href="blog.php">December 2021</a>
                    </li>
                    <li>
                        <a href="blog.php">November 2021</a>
                    </li>
                    <li>
                        <a href="blog.php">October 2021</a>
                    </li>
                    <li>
                        <a href="blog.php">September 2021</a>
                    </li>
                    <li>
                        <a href="blog.php">August 2021</a>
                    </li>
                </ul>
            </div>
            <div id="main">
