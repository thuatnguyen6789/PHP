...
<body>
	<div id="header">
		<div>
			...
			<a href="index.html" id="logo"><img src="{{URL::asset('images/logo.png')}}" alt="LOGO"></a>
		</div>
	</div>
	<div id="adbox">
		...
		<ul>
			<li>
				<a href=""><img src="{{URL::asset('images/men-shirt1.jpg')}}" alt="Img"></a>
			</li>
			<li>
				<a href=""><img src="{{URL::asset('images/woman-shirt1.jpg')}}" alt="Img"></a>
			</li>
			<li>
				<a href=""><img src="{{URL::asset('images/men-shirt2.jpg')}}" alt="Img"></a>
			</li>
			<li>
				<a href=""><img src="{{URL::asset('images/men-shirt2.jpg')}}" alt="Img"></a>
			</li>
