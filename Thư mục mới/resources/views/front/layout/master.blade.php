    ...
    <div class="header-top">
        ...
        <div class="ht-right">
            ...
            <div class="top-social">
                <a href="https://www.facebook.com/hiep.nguyenminh.9887"><i class="ti-facebook"></i></a>
        ...
        <div class="inner-header">
            <div class="row">
                <div class="col-lg-2 col-md-2">
                    <div class="logo">
                        <a href="#">
                            <img src="front/img/logo.jpg" height="25" alt="">
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-3">
                <div class="footer-left">
                    <div class="footer-logo">
                        <a href="index.html">
                            <img src="front/img/logo.jpg" height="25">
                        </a>
                    </div>
                    <ul>
                        <li>Ton That Thuyet - My Dinh - Ha Noi</li>
                        <li>phone: 03344550</li>
                        <li>email: nguyenminhhiep@gmail.com</li>
                    </ul>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="copyright-text">
                        copyright <script>document.write(new Date().getFullYear());</script>All rights reserved i this template is made with <i class="fa fa-heat-0" aria-hidden="true"></i> by <a href="https://Codelean.vn
